...
<head>
    ...
    <title>BPMS -Staff Homepage</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="staffhome.php">
                ...
                <div class="sidebar-brand-text mx-3">BPMS<br>Staff Homepage</div>
            </a>
...
$lkey=$_COOKIE['lkey'];
$sql = "select * from tb_staffreg where loginid='".$lkey."'"; //echo $sql;exit;
