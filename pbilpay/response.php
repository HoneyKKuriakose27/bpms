...
header( "refresh:8;url=../customer/productbookings.php" );
$postdata = $_POST;
$msg = '';
if (isset($postdata ['key'])) {
    ...
    if ($status == 'success'  && $resphash == $CalcHashString) {
        ...
        $sql="update tb_productbookings set pb_feedback='Bill Paid', pbstatus='4' where pbkey='".$t."'"; //echo $sql;exit;
...
<title>Service Booking Payment</title>
</head>
<style type="text/css">
    .main {
        margin-left:30px;
...
<div class="main">
    ...
    <div>
        <h3><font color="green">Service Booking Bill Payment Success</font></h3>
    </div>
    ...
    <div>
        <h3><font color="red">Page Will Be Redirected in 5 sec...</font></h3>
    </div>
</div>
</body>
</html>