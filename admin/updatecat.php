...
include '../connection.php';
  ...
  $sql = "select * from tb_category where catkey='".$_GET['t']."'"; //echo $sql;exit;
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body" >
                          ...
                          <form role="form" action="updatecategoryreg.php" method="post" enctype="multipart/form-data" name="myform">
<?php while ($row=mysqli_fetch_array($result))
                      {  ?>
              			    			<div class="form-group">
              			    				<input type="text" name="cname"  class="form-control input-sm" placeholder="Product Category Name" value="<?php echo $row['catname'] ?>" id="fname" onkeyup="firstName()">
